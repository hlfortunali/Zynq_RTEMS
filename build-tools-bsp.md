...
#### RTEMS5   
 ...
 2. If we need to debug the RTEMS kernel, the CFLGAS need to be set to " -O0 -g3 "  in both rsb and rtems bsp and libbsp for xilinx_zynq. We can use vscode to open the two souce folder and search for "-O2" and then change the flags.   
